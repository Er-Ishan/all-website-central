...
@media (min-width: 992px) {
  .hero-text-box {
    margin-right: 0;
    transform: translateX(40px); /* 👈 pushes more right */
  }
}
                            ...
                            <div className="carousel-caption">
                                <div className="container py-4">
                                    <div className="row g-3 align-items-center justify-content-between">
                                        ...
                                        <div
                                            className="col-lg-6 d-none d-lg-flex justify-content-end align-items-center"
                                            data-animation="fadeInRight"
                                            data-delay="1s"
                                            style={{ animationDelay: "1s" }}
                                        >
                                            <div className="hero-text-box text-start">

                                                {/* SMALL TOP HEADING */}
                                                {/* <p className="hero-top-heading" style={{ color: "#005c25", fontSize: "22px" }}>
                                                    Compare & Save with Elite Parking
                                                </p> */}

                                                <h2 className="hero-heading text-black">
                                                    Heathrow Airport Parking (Parking) Secure – Heathroweliteparking
                                                </h2>

                                                <p className="hero-text text-black">
                                                   Flying out of Heathrow soon? then there is the likelihood that you already have in the back of your mind parking. Maybe a small concern. Perhaps a larger one than you would wish to acknowledge.

                                                </p>

                                                {/* CTA BUTTON */}
                                                <button
                                                    className="hero-compare-btn mt-3"
                                                >
