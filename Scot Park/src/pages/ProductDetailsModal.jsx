...
export default function ProductDetails() {
                                    ...
                                    {[
                                        ...
                                        <li className="nav-item flex-fill text-center" key={key}>
                                            <button
                                                ...
                                                style={{
                                                    backgroundColor: activeTab === key ? "#0A1A3A" : "#fff",
                                                    color: activeTab === key ? "#fff" : "#0A1A3A",
                                                    borderRadius: "8px",
                                                    padding: "12px 0",
    ...
    <>
        ...
        {product.product_overview ? (
            <div
                className="overview-content fs-6 lh-lg text-secondary"
    ...
    <>
        ...
        {product.return_procedure ? (
            <div
                className="description-content fs-6 lh-lg text-secondary"
                dangerouslySetInnerHTML={{
                    __html: product.return_procedure,
                }}
            />
        ) : (
            <p className="fs-6 text-muted">
    ...
    <>
        ...
        {product.dropoff_procedure ? (
            <div
                className="procedure-content fs-6 lh-lg text-secondary"
                dangerouslySetInnerHTML={{
                    __html: product.dropoff_procedure,
                }}
            />
        ) : (
            <p className="fs-6 text-muted">
                No drop-off procedure available.
            </p>
        )}
    </>
)}
                            ...
                            <div className="col-lg-4">
                                <div className="card h-100 border-2">
                                    <div className="card-body p-4 d-flex flex-column text-center">
                                        ...
                                        {/* Title */}
                                        {/* <h4 className="fw-bold mb-1" style={{ color: "#0A1A3A" }}>
                                        ...
                                        <ul className="list-unstyled text-start mb-4">
                                            ...
                                            <li className="d-flex align-items-start gap-2 mb-2">
                                                <IoIosCheckmarkCircle className="mt-1" size={18} style={{ color: "#0A1A3A" }} />
